//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/kalyan3104/protobuf/protobuf  --gogoslick_out=. block.proto
package block
...
import (
	...
	"github.com/kalyan3104/k-core/data/headerVersionData"
)
