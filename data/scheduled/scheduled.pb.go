...
import (
	...
	github_com_kalyan3104_k_core_go_data "github.com/kalyan3104/k-core/data"
	block "github.com/kalyan3104/k-core/data/block"
	smartContractResult "github.com/kalyan3104/k-core/data/smartContractResult"
	transaction "github.com/kalyan3104/k-core/data/transaction"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type GasAndFees struct {
	AccumulatedFees *math_big.Int `protobuf:"bytes,1,opt,name=AccumulatedFees,proto3,casttypewith=math/big.Int;github.com/kalyan3104/k-core/data.BigIntCaster" json:"AccumulatedFees,omitempty"`
	DeveloperFees   *math_big.Int `protobuf:"bytes,2,opt,name=DeveloperFees,proto3,casttypewith=math/big.Int;github.com/kalyan3104/k-core/data.BigIntCaster" json:"DeveloperFees,omitempty"`
...
func (this *GasAndFees) Equal(that interface{}) bool {
	...
	{
		__caster := &github_com_kalyan3104_k_core_go_data.BigIntCaster{}
